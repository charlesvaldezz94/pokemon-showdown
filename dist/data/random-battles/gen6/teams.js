...
var import_teams2 = __toESM(require("../gen7/teams"));
...
class RandomGen6Teams extends import_teams2.default {
  constructor(format, prng) {
    ...
    this.moveEnforcementCheckers = {
      Bug: (movePool, moves, abilities, types, counter) => ["megahorn", "pinmissile"].some((m) => movePool.includes(m)) || !counter.get("Bug") && abilities.includes("Tinted Lens"),
      ...
      Flying: (movePool, moves, abilities, types, counter, species) => !counter.get("Flying") && !["aerodactyl", "aerodactylmega", "mantine", "murkrow"].includes(species.id) && !movePool.includes("hiddenpowerflying"),
      ...
      Ice: (movePool, moves, abilities, types, counter) => !counter.get("Ice") || moves.has("icebeam") && movePool.includes("freezedry") || abilities.includes("Refrigerate") && (movePool.includes("return") || movePool.includes("hypervoice")),
...
var teams_default = RandomGen6Teams;
